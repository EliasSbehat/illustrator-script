...
function createXML() {
    ...
    for (var i=0; i<textFrames.length; i++) {
        ...
        // xml += '<Paragraphs Number="1" AutoLeadingAmount="'+textAttr.autoLeading+'" HyphenateCapitalizedWords="true" Hyphenation="true" HyphenationPreference="0.5" HyphenationZone="36" KinsokuOrder="aiPushIn" KurikaeshiMojiShori="false" LeftIndent="0" MaximumConsecutiveHyphens="0" MaximumGlyphScaling="100" MaximumLetterSpacing="0" MaximumWordSpacing="133.00000429153442" MinimumAfterHyphen="2" MinimumBeforeHyphen="2" MinimumGlyphScaling="100" MinimumHyphenatedWordSize="6" MinimumLetterSpacing="0" MinimumWordSpacing="80.0000011920929" RightIndent="0" RomanHanging="false" SpaceAfter="0" SpaceBefore="0">';
